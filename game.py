...
class Game:
    ...
    def draw_around(self):
        ...
        if DEBUG():
            around.fill((0, 0, 0))
            return around
        for x in range(self.env.map_width + 2):
        ...
        for y in range(1, self.env.map_height + 2):
...
if __name__ == "__main__":
    ...
    number_of_display = 1
    for x in range(number_of_display):
